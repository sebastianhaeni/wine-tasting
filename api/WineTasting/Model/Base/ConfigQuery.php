...
use WineTasting\Model\Config as ChildConfig;
use WineTasting\Model\ConfigQuery as ChildConfigQuery;
use WineTasting\Model\Map\ConfigTableMap;
 ...
 *
 *
 * @method     ChildConfigQuery orderByIdConfig($order = Criteria::ASC) Order by the idConfig column
 ...
 *
 * @method     ChildConfigQuery groupByIdConfig() Group by the idConfig column
 ...
 *
 * @method     ChildConfig findOneByIdConfig(int $idConfig) Return the first ChildConfig filtered by the idConfig column
 ...
 *
 * @method     ChildConfig requireOneByIdConfig(int $idConfig) Return the first ChildConfig filtered by the idConfig column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildConfig[]|ObjectCollection findByIdConfig(int $idConfig) Return ChildConfig objects filtered by the idConfig column
...
abstract class ConfigQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \WineTasting\Model\Base\ConfigQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\WineTasting\\Model\\Config', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT idConfig, name, value FROM config WHERE idConfig = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(ConfigTableMap::COL_IDCONFIG, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(ConfigTableMap::COL_IDCONFIG, $keys, Criteria::IN);
    }

    /**
     * Filter the query on the idConfig column
     *
     * Example usage:
     * <code>
     * $query->filterByIdConfig(1234); // WHERE idConfig = 1234
     * $query->filterByIdConfig(array(12, 34)); // WHERE idConfig IN (12, 34)
     * $query->filterByIdConfig(array('min' => 12)); // WHERE idConfig > 12
     * </code>
     *
    ...
    public function filterByIdConfig($idConfig = null, $comparison = null)
    {
        if (is_array($idConfig)) {
            ...
            if (isset($idConfig['min'])) {
                $this->addUsingAlias(ConfigTableMap::COL_IDCONFIG, $idConfig['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($idConfig['max'])) {
                $this->addUsingAlias(ConfigTableMap::COL_IDCONFIG, $idConfig['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ConfigTableMap::COL_IDCONFIG, $idConfig, $comparison);
    }
