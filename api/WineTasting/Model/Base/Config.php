...
abstract class Config implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\WineTasting\\Model\\Map\\ConfigTableMap';
    ...
    /**
     * The value for the idconfig field.
     * @var        int
     */
    protected $idconfig;
    ...
    /**
     * Initializes internal state of WineTasting\Model\Base\Config object.
     */
    ...
    /**
     * Set the value of [idconfig] column.
     *
     * @param int $v new value
     * @return $this|\WineTasting\Model\Config The current object (for fluent API support)
     */
    public function setIdConfig($v)
    {
        ...
        if ($this->idconfig !== $v) {
            $this->idconfig = $v;
            $this->modifiedColumns[ConfigTableMap::COL_IDCONFIG] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ConfigTableMap::translateFieldName('IdConfig', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idconfig = (null !== $col) ? (int) $col : null;
            ...
            return $startcol + 3; // 3 = ConfigTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\WineTasting\\Model\\Config'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'idConfig':
                        $stmt->bindValue($identifier, $this->idconfig, PDO::PARAM_INT);
                        break;
                    case 'name':
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\WineTasting\Model\Config
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\WineTasting\Model\Config The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ConfigTableMap::COL_IDCONFIG)) {
            $criteria->add(ConfigTableMap::COL_IDCONFIG, $this->idconfig);
        }
        if ($this->isColumnModified(ConfigTableMap::COL_NAME)) {
    ...
    /**
     * Generic method to set the primary key (idconfig column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \WineTasting\Model\Config (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \WineTasting\Model\Config Clone of current object.
     * @throws PropelException
     */
